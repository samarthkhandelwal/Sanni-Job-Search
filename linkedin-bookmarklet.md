...
```text
javascript:(function(){var $=function(s){return document.querySelector(s);};var T=function(el){return el?el.textContent.trim().replace(/\s+/g,' '):'';};var title=T($('h1.t-24')||$('.job-details-jobs-unified-top-card__job-title h1')||$('.job-details-jobs-unified-top-card__job-title')||$('.jobs-unified-top-card__job-title h1')||$('.jobs-unified-top-card__job-title')||$('h1'));var companyEl=$('.job-details-jobs-unified-top-card__company-name a')||$('.jobs-unified-top-card__company-name a')||$('.job-details-jobs-unified-top-card__company-name')||$('.jobs-unified-top-card__company-name')||$('[data-test-id="job-poster"]');var company=T(companyEl);var location=T($('.job-details-jobs-unified-top-card__primary-description-container .tvm__text')||$('.job-details-jobs-unified-top-card__primary-description-container span')||$('.jobs-unified-top-card__bullet')||$('[data-test-id="job-location"]'));var descEl=$('.jobs-description__content')||$('#job-details')||document.querySelector('[class*="jobs-description__container"]')||document.querySelector('article');var description=T(descEl).slice(0,6000);var url=window.location.href.split('?')[0];if(!title||!company){alert('Could not detect LinkedIn job info. Make sure you have clicked on a job in the list so the full posting is visible on the right.');return;}var job={title:title,company:company,location:location,description:description,url:url};var encoded=encodeURIComponent(btoa(unescape(encodeURIComponent(JSON.stringify(job)))));var DASHBOARD='YOUR_DASHBOARD_URL_HERE';window.open(DASHBOARD.replace(/\/$/,'')+'/#linkedin='+encoded,'_blank');})();
```
